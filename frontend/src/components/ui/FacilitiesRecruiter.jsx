...
const FacilitiesRecruiter = () => {
  return (
    <div className="py-4">
      <div class="max-w-6xl mx-auto">
        <div className="max-w-3xl mx-auto mb-16 text-cente">
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-12">
          <div className="text-center">
            <div className="w-12 h-12 p-3 rounded-md flex items-center justify-center mx-auto bg-blue-50 mb-6">
              <svg
                ...
                className="fill-blue-700 w-full h-full inline-block"
                viewBox="0 0 100 100"
              >
                <path
            ...
            <p className="text-slate-600 text-sm leading-relaxed">
              Easily tailor every aspect of the platform to suit your business
              needs. From design tweaks to functional preferences and operate.
            </p>
          </div>
          ...
          <div className="text-center">
            <div className="w-12 h-12 p-3 rounded-md flex items-center justify-center mx-auto bg-pink-50 mb-6">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="text-pink-700 w-full h-full inline-block"
            ...
            <p className="text-slate-600 text-sm leading-relaxed">
              ...
              encryption and real-time threat detection to keep your data safe.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-slate-600 text-sm leading-relaxed">
              ...
              you. we’re here to ensure your experience remains smooth.
            </p>
          </div>
          ...
          <div className="text-center">
            <div className="w-12 h-12 p-3 rounded-md flex items-center justify-center mx-auto bg-purple-50 mb-6">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="fill-purple-700 w-full h-full inline-block"
                viewBox="0 0 512 512"
              >
                <path
            ...
            <p className="text-slate-600 text-sm leading-relaxed">
              Experience lightning-fast load times and seamless performance. Our
              system is built to deliver results without lag or disruption.
            </p>
          </div>
          ...
          <div className="text-center">
            <div className="w-12 h-12 p-3 rounded-md flex items-center justify-center mx-auto bg-orange-50 mb-6">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="text-orange-700 w-full h-full inline-block"
                viewBox="0 0 682.667 682.667"
              >
                <defs>
            ...
            <p className="text-slate-600 text-sm leading-relaxed">
              Whether you're a startup or enterprise. Add users, features, or
              capabilities without disrupting performance.
            </p>
          </div>
          ...
          <div className="text-center">
            <div className="w-12 h-12 p-3 rounded-md flex items-center justify-center mx-auto bg-blue-50 mb-6">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="text-blue-700 w-full h-full inline-block"
                viewBox="0 0 682.667 682.667"
              >
                <defs>
                  <clipPath id="a" clipPathUnits="userSpaceOnUse">
...
export default FacilitiesRecruiter;
